...
const Index = () => {
  const speakers = [
    ...
    { name: "Puwasala Gamakumara", company: "Monash University", avatar: "PG", image: "/lovable-uploads/puwasala-gamakumara.jpg", linkedin: "https://www.linkedin.com/in/puwasala-gamakumara-phd/" },
